                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            <a class="nav-item nav-link" href="#header_section">Home</a>
                            <a class="nav-item nav-link" href="#collection_section">Collection</a>
                            <a class="nav-item nav-link" href="#racingBootsSection">Racing Boots</a>
                            <a class="nav-item nav-link" href="#newArrivalSection">Shoes</a>
                            <a class="nav-item nav-link" href="#contactSection">Contact</a>
                            <a class="nav-item nav-link last" href="#"><img
                                    src="<?=base_url() ?>images/search_icon.png"></a>
                            <a class="nav-item nav-link last" href="contact.html"><img
                                    src="<?=base_url() ?>images/shop_icon.png"></a>
                        </div>
                    </div>
                </nav>
            </div>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="shoes_img"><img src="<?=base_url() ?>images/running-shoes.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="shoes_img"><img src="<?=base_url() ?>/running-shoes.png"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
