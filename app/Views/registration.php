...
<body>
    ...
    <div class="container-fluid">
        <div class="form-box">
            ...
            <form class="form" action="<?php echo base_url()?>registration" method="post">
                <span class="title">Sign up</span>
                <span class="subtitle">Create a account with your email.</span>
                <div class="form-container">
                    <input type="text" class="input" placeholder="Full Name" name="name"
                        value="<?= set_value('name')?>">
                    <input type="email" class="input" placeholder="Email" name="email" value="<?= set_value('email')?>">
